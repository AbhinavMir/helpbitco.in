        ...
        <div class="flex h-full text-gray-600 dark:text-gray-400">
          ...
          <a v-on:click="pullrequest = true"
           ...
           <div class="visible md:invisible flex">           
            <button onClick="window.location='https://github.com/abhinavmir/help-ethereum/blob/main/ADDPROJECT.md'" class="h-2/3 m-auto mr-2 rounded-md shadow text-white bg-blue-500">Add a project</button>
            <button onClick="window.location='https://github.com/abhinavmir/help-ethereum/blob/main/DEV.md'" class="h-2/3 m-auto rounded-md shadow text-white bg-blue-500">I am a dev</button>  
           </div>
        </div>
        <div class="ml-auto mt-4 flex items-center space-x-7 hidden sm:block">
           <button onClick="window.location='https://github.com/abhinavmir/help-ethereum/blob/main/ADDPROJECT.md'" class="h-8 px-3 rounded-md shadow text-white bg-blue-500">Add a project</button>
           <button onClick="window.location='https://github.com/abhinavmir/help-ethereum/blob/main/DEV.md'" class="h-8 px-3 rounded-md shadow text-white bg-blue-500">I am dev</button>
        </div>
      </div>
